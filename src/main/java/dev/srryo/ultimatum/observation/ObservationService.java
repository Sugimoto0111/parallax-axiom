package dev.srryo.ultimatum.observation;
...
public final class ObservationService {
    ...
    public static final String OBSERVATION_TAG = "UltimatumObservation";
    private static final String MODE_TAG = "Mode";
    private static final String COUNT_TAG = "Count";
    private static final String TERMINAL_RECORDED_TAG =
            "UltimatumTerminalObservationRecorded";
    private static final TagKey<EntityType<?>> OBSERVABLE_CONCLUSIONS = TagKey.create(
            Registries.ENTITY_TYPE,
            new ResourceLocation(UltimatumMod.MOD_ID, "observable_conclusions"));
    ...
    public static boolean record(Player player, Mode requestedMode) {
        ...
        if (existingMode != null && existingMode != requestedMode) {
            player.displayClientMessage(Component.translatable(
                    "message.ultimatum.observation.locked."
        ...
        if (count < REQUIRED_OBSERVATIONS) {
            player.displayClientMessage(Component.translatable(
                    "message.ultimatum.observation.progress."
        ...
        player.displayClientMessage(Component.translatable(
                "message.ultimatum.observation.complete."

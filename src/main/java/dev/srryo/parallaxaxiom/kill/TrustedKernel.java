...
public final class TrustedKernel {
    ...
    static {
        ...
        try {
            ...
            ParallaxAxiomMod.LOGGER.error("Could not initialize the hidden execution kernel", error);
        }
        EXECUTE_PIG = execute;
        RESET_PIG = reset;
    }
    ...
    public static boolean executePig(Object target, Object level) {
        ...
        try {
            ...
            ParallaxAxiomMod.LOGGER.error("Hidden Pig2 execution failed", error);
            return false;
        }
    }
    ...
    public static void resetPig(Object pig2Class) {
        ...
        try {
            ...
            ParallaxAxiomMod.LOGGER.error("Hidden Pig2 reset failed", error);
        }
    }

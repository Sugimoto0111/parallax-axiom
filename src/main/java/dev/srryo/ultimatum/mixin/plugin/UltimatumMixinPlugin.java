package dev.srryo.ultimatum.mixin.plugin;

import dev.srryo.ultimatum.agentloader.AgentLoader;
...
public final class UltimatumMixinPlugin implements IMixinConfigPlugin {
    static {

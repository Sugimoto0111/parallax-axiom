...
/** Toggleable utility powers supplied by the Absolute Artifact. */
public final class ArtifactUtilityService {
    public static final String NIGHT_VISION_TAG = "UltimatumNightVision";
    public static final String ITEM_MAGNET_TAG = "UltimatumItemMagnet";
    ...
    public void toggleNightVision(ServerPlayer player) {
        toggle(player, NIGHT_VISION_TAG, "message.ultimatum.night_vision");
        updateNightVision(player);
    }

    public void toggleItemMagnet(ServerPlayer player) {
        toggle(player, ITEM_MAGNET_TAG, "message.ultimatum.magnet");
